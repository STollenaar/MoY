...
public class Playerstats {
	...
	public static HashMap<Block, UUID> allthosefurnaces = new HashMap<Block, UUID>();
	public static HashMap<Block, ItemStack> furnacestore = new HashMap<Block, ItemStack>();
	// general stats
